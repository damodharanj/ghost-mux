...
| [src/bin/server.rs](file:///Users/saranyadamo/Downloads/ghost-mux/src/bin/server.rs) | Headless Server — processes JSON-RPC requests (such as [pty.list](file:///Users/saranyadamo/Downloads/ghost-mux/src/bin/server.rs#L520)), and serves embedded static files for the Web Dashboard |
